...
namespace utils
{
    ...
    void ZlibCompress::reset_stream()
    {
    ...
    void ZlibCompress::reset_uncompress_stream_()
    {
    ...
    size_t ZlibCompress::compressed_bound(size_t input_size)
    {
